            ...
            <>
                <div className="wrapper">
                    <div className="inner-wrapper">
                        ...
                        <p>
                            You&apos;ve just embarked on a magical hair journey!
                            Your hair length is {latestMeasurement}cm. Good
                            Growing!
                        </p>

                        <p>
                            You want to grow to {theOneUser.goalHairLength}cm
                            (you Rapunzel, you!) Based on the average human
                            growth rate, you have {theOneUser.timeTillGoal}{' '}
                            months till you meet your goal length
                        </p>
                        <p>
                            Your hair is {theOneUser.keyLength.toLowerCase()}{' '}
                            length - hoorah for you!
                        </p>
            ...
            <>
                <div className="wrapper">
                    <div className="inner-wrapper">
                        ...
                        <p>
                            You&apos;ve just embarked on a magical hair journey!
                            Your starting hair length is {theOneUser.hairLength}
                            cm. Good Growing!
                        </p>
